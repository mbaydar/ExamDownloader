...
public class AlesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		alesButton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				new DownloadFile("ales2013-sonbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-71131/h/ales2013-kasim-internet.pdf",
								"ales2013-sonbahar.pdf");
			}
		});
		alesButton2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2013-ilkbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-69210/h/ales2013ilkbahartemelsorukitapcigi.pdf",
								"ales2013-ilkbahar.pdf");
			}
		});
		...
		alesButton3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2012-sonbahar.pdf").execute(
						"http://www.osym.gov.tr/dosya/1-61215/h/ales2012.pdf",
						"ales2012-sonbahar.pdf");
			}
		});
		...
		alesButton4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2012-ilkbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-60020/h/ales201201temel-soru-kitapcigi.pdf",
								"ales2012-ilkbahar.pdf");
			}
		});
		...
		alesButton5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2011-sonbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-58836/h/sonbahar-donemi-ales.pdf",
								"ales2011-sonbahar.pdf");
			}
		});
		...
		alesButton6.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2011-ilkbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-57609/h/ales201101masterkitap.pdf",
								"ales2011-ilkbahar.pdf");
			}
		});
		...
		alesButton7.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2010-sonbahar.pdf")
						.execute(
								"http://dokuman.osym.gov.tr/pdfdokuman/arsiv/2010/ALES/19_12_2010_ales_sorular.pdf",
								"ales2010-sonbahar.pdf");
			}
		});
		...
		alesButton8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2010-ilkbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-52957/h/ales2010ilkbahar.pdf",
								"ales2010-ilkbahar.pdf");
			}
		});
		...
		alesButton9.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2009-sonbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-51262/h/ales2009sonbahar.pdf",
								"ales2009-sonbahar.pdf");
			}
		});
		...
		alesButton10.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				new DownloadFile("ales2009-ilkbahar.pdf")
						.execute(
								"http://www.osym.gov.tr/dosya/1-49327/h/ales2009ilkbahar.pdf",
								"ales2009-ilkbahar.pdf");
			}
		});
	...
	private class DownloadFile extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... strings) {
			...
			if (!alreadyExist && isNetworkAvailable()) {
				...
				File folder = new File(extStorageDirectory, "osym/ales");
				folder.mkdirs();
			...
			if (pdfFile.exists()) {
				...
				if (isNetworkAvailable()) {
					Toast.makeText(
							...
							Toast.LENGTH_LONG).show();
					progressDialog = ProgressDialog.show(AlesActivity.this,
		...
		protected void onPostExecute(Void result) {
			...
			if (isNetworkAvailable() && !alreadyExist) {
				...
				Toast.makeText(getApplicationContext(), getResources().getString(R.string.download_finished),
						Toast.LENGTH_LONG).show();
			}
	...
	public void view(View v, String name) {
		File pdfFile = new File(Environment.getExternalStorageDirectory()
				+ "/osym/ales/" + name); // -> filename = maven.pdf
		...
		try {
			...
			Toast.makeText(AlesActivity.this,
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ales, menu);
		return true;
	}
